...
const SystemArchitecture = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "relative w-full h-auto md:h-[600px] bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-6 md:p-8 overflow-hidden flex flex-col items-center justify-center",
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 md:gap-12 w-full md:w-[80%] justify-items-center md:absolute md:inset-0 md:m-auto md:grid-cols-none",
        ...
        "MetricsDemo.useEffect": ()=>{
            const interval = setInterval({
                "MetricsDemo.useEffect.interval": ()=>{
                    setMetrics({
                        "MetricsDemo.useEffect.interval": (prev)=>prev.map({
                                "MetricsDemo.useEffect.interval": (metric)=>({
                                        ...metric,
                                        value: metric.value < metric.max ? Math.min(metric.value + metric.max / 50, metric.max) : 0
                                    })
                            }["MetricsDemo.useEffect.interval"])
                    }["MetricsDemo.useEffect.interval"]);
                }
            }["MetricsDemo.useEffect.interval"], 50);
            return ({
...
_s(MetricsDemo, "g8xmaB2qb1ngyTPeo8GeLjznJu0=");
_c = MetricsDemo;
var _c;
...
//# sourceMappingURL=_beaf4faa._.js.map